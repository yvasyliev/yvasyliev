...
public class Reason {
    ...
    public static final String SUDOKU_SOLVED = "🎉 Congratulations! You solved the sudoku. Try to solve the new one: %s\n\nPS: If you liked it, please star the repo and share with your friends 🙄👉👈".formatted(RETURN_URL);
}
